...
public class Aufgabe5 {
	...
	public static void rabattsystem(double bestellcost) {
		if (bestellcost >= 0 && bestellcost <= 100) {
			...
			System.out.printf("Mit einem Rabatt von 10 Prozent liegt der Bestellwert incl. Mwst nun bei: %.2f€", mitRabatt);
		}
		else if (bestellcost > 100 && bestellcost <= 500) {
			double mitRabatt = (bestellcost * 0.85) * 1.16;
			System.out.printf("Mit einem Rabatt von 15 Prozent liegt der Bestellwert incl. Mwst nun bei: %.2f€", mitRabatt);
		}
		else {
			double mitRabatt = (bestellcost * 0.80) * 1.16;
			System.out.printf("Mit einem Rabatt von 20 Prozent liegt der Bestellwert incl. Mwst nun bei: %.2f€", mitRabatt);
		}
	}
